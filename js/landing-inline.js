      ...
      .then(function(res) {
        ...
        document.getElementById('rv-card').innerHTML = [
          '<div style="padding:40px 28px;text-align:center">',
            ...
            '<a href="https://g.page/r/CbDo2zM02zFaEBM/review" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:10px;padding:12px 16px;background:var(--surface);border:1px solid var(--border);border-radius:10px;text-decoration:none;margin-bottom:14px">',
